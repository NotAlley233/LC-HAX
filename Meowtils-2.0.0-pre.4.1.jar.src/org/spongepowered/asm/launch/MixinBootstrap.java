...
/* 129 */         throw new MixinInitialisationError("Mixin subsystem version " + getActiveSubsystemVersion() + " was already initialised. Cannot bootstrap version " + "0.7.10");
/*     */       }
/*     */       
/* 132 */       return false;
/*     */     } 
/*     */     
/* 135 */     registerSubsystem("0.7.10");
/*     */     
/* 137 */     if (!initialised) {
...
/* 169 */         logger.warn("Multiple Mixin containers present, init suppressed for 0.7.10");
/*     */         
/*     */         return;
/*     */       } 
...
/* 197 */     return "0.7.10".equals(getActiveSubsystemVersion());
/*     */   }
/*     */   
...
/* Location:              /Users/notalley/Downloads/Meowtils-2.0.0-pre.4.1.jar!/org/spongepowered/asm/launch/MixinBootstrap.class
